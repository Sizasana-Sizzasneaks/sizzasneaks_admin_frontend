This folder "src\components\reviews" holds all visual components associated with displaying product review 
data.
...
This component is used to display a rating value between 1 and 5 into visual rating stars.
